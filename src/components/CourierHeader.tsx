...
const CourierHeader = () => {
  return (
    <header className="bg-primary/95 backdrop-blur-md shadow-medium fixed top-0 left-0 right-0 z-[100] transition-all duration-300" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
