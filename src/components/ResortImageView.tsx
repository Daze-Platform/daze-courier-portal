      ...
      >
        <img 
          ...
          style={{ 
            margin: 0,
            padding: 0,
            width: focusArea === 'beach' ? '150%' : focusArea === 'pool' ? '220%' : '140%',
            height: focusArea === 'beach' ? '150%' : focusArea === 'pool' ? '180%' : '110%',
            top: focusArea === 'beach' ? '-25%' : focusArea === 'pool' ? '-30%' : '-5%',
            left: focusArea === 'beach' ? '15%' : focusArea === 'pool' ? '-15%' : '10%',
            objectFit: 'cover'
          }}
        />
      </div>
